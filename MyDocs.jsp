...
<!--End of Add Document -->
        ...
        <%
            ...
            List<Repository> docs = krp.getDocumentsByUser(user.getId());
        ...
        <div class="container  mt-4">
            ...
            <div class="row  align-items-start bordered-cell text-center " id="viewHeader"> 
                <div class="col ">
                    <p>Title</p> 
                </div>
                <div class="col">
            ...
            <div class="row align-items-start bordered-cell   viewAll">
                ...
                <div class="col">
                    <button class="btn btn-outline-danger delete-btn" data-doc-id="<%= repo.getId()%>">Delete</button>
                </div>
            </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $(".delete-btn").on("click", function () {
                    ...
                    // Show a confirmation dialog before proceeding with the delete action
                    swal({
                        title: "Are you sure?",
                        ...
                        if (willDelete) {
                            // If the user confirms the delete action, make an AJAX request to delete the document
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    if (data.trim() === "success") {
                                        swal("Document deleted successfully!", {
                                            ...
                                            // Refresh the page to show the updated document list after deletion
                                            location.reload();
                                        });
                                    } else {
